...
// ── MEALS ──
const MEALS = [
  {time:'07.00–08.00',kcal:450,pro:28,name:'ไข่ต้ม/ไข่คน 3 ฟอง + ข้าวโอ๊ต 40 ก. + กล้วย 1 ลูก',alt:'ทางเลือก: โจ๊กหมูใส่ไข่, ข้าวต้มปลา'},
  {time:'10.30',kcal:200,pro:17,name:'กรีกโยเกิร์ตไม่หวาน 1 ถ้วย + อัลมอนด์ 15–20 เม็ด',alt:''},
  {time:'12.00–13.00',kcal:520,pro:45,name:'ข้าวกล้อง 1 ทัพพี + อกไก่/ปลา 180 ก. + ผักเยอะๆ',alt:'เมนู: ข้าวอกไก่ย่าง, สลัดอกไก่, ต้มยำปลาน้ำใส'},
  {time:'~18.30 (ก่อนเล่น)',kcal:120,pro:2,name:'กล้วย 1 ลูก หรือแอปเปิล + กาแฟดำ/อเมริกาโน่',alt:'ให้พลังงานก่อนออกกำลังกาย'},
  {time:'20.15–20.30 (หลังเล่น)',kcal:480,pro:48,name:'อกไก่/ปลา/เต้าหู้ 200 ก. + ผักนึ่ง + ข้าวครึ่งทัพพี',alt:'เน้นโปรตีน+ผัก ลดแป้ง'},
  {time:'ถ้าหิว',kcal:120,pro:20,name:'นมจืดพร่องมันเนย 1 แก้ว หรือเวย์โปรตีน 1 สกู๊ป',alt:''},
];
